...
public class RangeSliderUI extends BasicSliderUI {
	...
	public void installUI(JComponent c) {
		...
		horizontalLowerThumbIcon = makeIcon(RangeSliderUI.header, RangeSliderUI.hl);
		horizontalUpperThumbIcon = makeIcon(RangeSliderUI.header, RangeSliderUI.hu);
		verticalLowerThumbIcon = makeIcon(RangeSliderUI.header, RangeSliderUI.vl);
		verticalUpperThumbIcon = makeIcon(RangeSliderUI.header, RangeSliderUI.vu);
	}
