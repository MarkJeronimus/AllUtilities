			...
			case 4:
				for (int y = image.border; y < image.endY; y++) {
					...
					for (x = image.border; x < endX; x++) {
						...
						g = row1[x];
						b = row2[x];
						row0[x] = +0.29900000000000000000f * r + 0.58700000000000000000f * g +
						          0.11400000000000000000f * b;
						row1[x] = -0.14713769751693002257f * r - 0.28886230248306997742f * g +
						          0.43600000000000000000f * b;
						row2[x] = +0.61500000000000000000f * r - 0.51498573466476462197f * g -
