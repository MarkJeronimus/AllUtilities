...
import static org.digitalmodular.utilities.gui.swing.tablelayout.Size.Priority.EXACT;
import static org.digitalmodular.utilities.gui.swing.tablelayout.Size.Priority.MINIMUM;
...
public class Size {
	...
	public void setPreferred(double preferred) { this.preferred = preferred; }
	...
	public void recordComponent(int preferredSize, int minimumSize) {
		switch (priority) {
			...
			case RELATIVE:
				minimum = Math.max(minimum, minimumSize);
				preferred = clamp(1, preferred, preferredSize);
				break;
		}
	}
