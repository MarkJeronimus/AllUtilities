 ...
 * thread name may optionally be specified for reflective purposes and/or clarity, e.g. for the Swing EDT, the name
 * should be {@code "AWT-EventQueue-0"}.
 * <p>
 * This annotation supersedes both {@link ThreadSafe} and {@link NotThreadSafe}.
 *
