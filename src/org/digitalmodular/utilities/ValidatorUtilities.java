...
public final class ValidatorUtilities {
	private ValidatorUtilities() { throw new AssertionError(); }
	...
	public static <T> T requireNonNull(T actual, String varName) {
		if (actual == null)
	...
	public static String requireStringLengthAtLeast(int minLength, String actual, String varName) {
		...
		if (actual.length() < minLength)
			throw new IllegalArgumentException(
					'\'' + varName + "' must be at least " + minLength + " elements long: " + actual.length());
		return actual;
	}

	public static Object requireArrayLengthExactly(int length, Object actual, String varName) {
		requireNonNull(actual, varName);
	...
	public static Object requireArrayLengthAtLeast(int minLength, Object actual, String varName) {
		requireNonNull(actual, varName);
		if (!actual.getClass().isArray())
			throw new AssertionError(varName + " is not an array");
	...
	public static Object requireArrayLengthAtMost(int maxLength, Object actual, String varName) {
		requireNonNull(actual, varName);
		if (!actual.getClass().isArray())
			throw new AssertionError(varName + " is not an array");
	...
	public static @Nullable Object requireNullOrLengthAtLeast(int min, @Nullable Object actual, String varName) {
		if (actual == null)
			return null;
