...
public class IndexedLinkedList implements Iterable<IndexedLinkedListElement> {
	...
	public IndexedLinkedListElement[] toArray() {
		IndexedLinkedListElement[] array = new IndexedLinkedListElement[elementCount];
	...
	public IndexedLinkedListElement[] toArray(IndexedLinkedListElement[] array) {
		...
		if (array.length < elementCount) {
			array = (IndexedLinkedListElement[])Array
	...
	public boolean add(IndexedLinkedListElement newElement) {
		String                   newIdentifier = newElement.getIdentifier();
		IndexedLinkedListElement next          = findAfter(newIdentifier);
	 ...
	 * @see #contains(nl.airsupplies.utilities.collection.containers.IndexedLinkedListElement)
	 */
	 ...
	 * @throws NullPointerException if a link in the linked list is broken.
	 * @throws NullPointerException if the specified collection is <tt>null</tt>.
	 * @see #remove(nl.airsupplies.utilities.collection.containers.IndexedLinkedListElement)
	 */
	 ...
	 * list.findAfter()}, then after this piece of user code:
	 *
	 * <pre>
	 * if (next == null)
	 * 	list.add(e);
